...
export default function Home() {
  ...
  async function saveResultToGoogleDocs() {
    if (!result.trim()) {
      alert("저장할 AI 분석 결과가 없습니다.");
      return;
    }
...
Generated by zenome Lab AI Hub
...
`;
      ...
      setSavedDocUrl(data.webViewLink || "");
      alert(`Google Docs로 저장되었습니다. 저장 폴더: ${data.folderName}`);
    } catch (error) {
      console.error(error);
      alert("Google Docs 저장에 실패했습니다.");
    } finally {
      setSavingDoc(false);
    }
  }
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <section className="mt-8 border border-yellow-500 rounded-xl p-5">
          ...
          <div className="flex flex-wrap gap-3 mt-4">
            ...
            <button
              onClick={saveResultToGoogleDocs}
              disabled={savingDoc || result.trim() === ""}
              className="px-6 py-3 bg-green-600 text-white rounded font-semibold disabled:opacity-50"
            >
            ...
            {savedDocUrl && (
              <a
                href={savedDocUrl}
                target="_blank"
                className="px-6 py-3 bg-green-700 text-white rounded font-semibold"
              >
                Open Saved Doc
              </a>
            )}
